...
; BEGIN PROBLEM 0
;;; Question 6
(define year (* 2 (+ 9 (* 100 (- 100 90)))))
; expect year
year
; expect 2018

(define no parenthesis here)
; expect Error

;;; Question 7
`(the year is ,year)
; expect (the year is 2018)

;;; Question 8 and 9
(define z (begin (define x 1) (define y 2) ((lambda (x y) (+ x y)) 1 2)))
; expect z
(list x y z)
; expect (1 2 3)

;;; Question 10
(define (func supports many bodies) (list supports many bodies))
; expect func
(func 'yay 'it 'works)
; expect (yay it works)

;;; Question 11
(make_child_frame '(x y z) '(1 2 3 4 5))
; expect Error
...
;;; Question 14
(cond ((= 1 (- 100 99)) 'finish-here) (else (/ 1 0)))
; expect finish-here

;;; Question 15
(let ((year 2019)) (print year))
; expect 2019
year
; expect 2018
(let ((too many here)) (print nope))
; expect Error

;;; Question 16
(define (f (mu () (not-enough-args))))
; expect Error
